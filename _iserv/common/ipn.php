...
function DeliverOrderByEmail( $orderid ) 
{
	...
	$IPN_DEFAULT_LANG = "en";
	$IPN_SUPPORTED_LANGS = array( "en" ); 
	$IPN_EMAIL_FDL_TITLE = array( "en" => "Delivery of your order {OrderID}" );
	$IPN_EMAIL_FDL_MSG = array( "en" => "Dear {ClientName},\r\nplease find below the files you purchased in your order [OrderID}:\r\n\r\n{DLFILES}\r\nThanks you." );
